...
public class DealDetailActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    @Bind(R.id.layout_fineprint)
    LinearLayout linearlayout_findprint;
    @Bind(R.id.layout_thid_deal)
    LinearLayout linearLayout_thisdetal;
    ...
    @Bind(R.id.txt_detail_sold)
    TextView txt_sold_out;
    @Bind(R.id.txt_detail_orign_price)
    TextView txt_Origin_price;
    @Bind(R.id.txt_detail_Promotion)
    TextView txt_Promotion_pric;
    @Bind(R.id.text_mmk_stike)
    TextView mmk_stike;
    @Bind(R.id.sib_simple_usage)
    SimpleImageBanner image_banner;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //image_banner = new SimpleImageBanner(getBaseContext());
    ...
    private void PrepareListData() {
        ...
        // imagebanner for deals

        //sib.setSource(DataProvider.getList(urls)).startScroll();
       image_banner.setSource(DataProvider.getList(DataProvider.urls)).startScroll();
